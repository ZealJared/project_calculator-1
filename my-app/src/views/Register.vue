    ...
    <div class="card-body">
      ...
      <form enctype="multipart/form-data" @submit.prevent="handleRegister">
        ...
        <div class="mb-3">
          ...
          <input type="file" accept=".jpg,.jpeg,.png" class="form-control" name="avatar" id="avatar">
        </div>
        <div class="row align-items-center">
          <div class="col"><button type="submit" class="btn btn-primary">Register</button></div>
          <div class="col"><router-link :to="{ name: 'Login' }">Existing user? Log in.</router-link></div>
        </div>
      </form>
    </div>
  </div>
